...
var relativePath = function relativePath(route) {
  return _path2.default.join(process.cwd(), route);
};

if (require.main === module) {
  var args = (0, _argumentExtract2.default)(process.argv);
  if (!args.path) {
    throw TypeError('Undefined path to the file, please include --path flag');
  }
  var file = _fs2.default.readFileSync(relativePath(args.path), { encoding: 'utf-8' });

  var converted = (0, _extractor2.default)(file);
...
exports.default = _extractor2.default;